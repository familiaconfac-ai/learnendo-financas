...
export async function createRecurrenceRule(uid, transactionData, recurrenceInput, options = {}) {
  ...
  const rule = {
    ...
    subcategoryName: transactionData.subcategoryName || null,
    notes: transactionData.notes || '',
    paymentMethod: transactionData.paymentMethod || null,
    cardId: transactionData.cardId || null,
    cardName: transactionData.cardName || null,
    transactionNatureId: transactionData.transactionNatureId || null,
    transactionNatureKey: transactionData.transactionNatureKey || null,
    transactionNatureLabel: transactionData.transactionNatureLabel || null,
    origin: 'manual',
    status: 'confirmed',
    balanceImpact: typeof transactionData.balanceImpact === 'boolean'
      ? transactionData.balanceImpact
      : transactionData.type !== 'transfer_internal',
    affectsBudget: typeof transactionData.affectsBudget === 'boolean'
      ? transactionData.affectsBudget
      : transactionData.type !== 'transfer_internal',
    workspaceId,
    ...recurrenceBase,
